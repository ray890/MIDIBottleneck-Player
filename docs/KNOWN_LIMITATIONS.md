...
- Forward-only queue limiting without slowdown supports Drop newest and Drop incoming complete notes. Drop oldest and clear/catch-up require Simulate slowdown because already-sent MIDI cannot be retracted.
